    ...
    if (projectImage != null) {
      try {
        final metadata = SettableMetadata(
            ...
            customMetadata: {'picked-file-path': projectImage.path});

        if (kIsWeb) {
          await FirebaseStorage.instance
              .ref()
              .child('projects/${projectID}/${projectID}.png')
              .putData(await projectImage.readAsBytes(), metadata);
        } else {
          await FirebaseStorage.instance
              .ref()
              .child('projects/${projectID}/${projectID}.png')
              .putFile(projectImage, metadata);
        }

        project['image'] = await FirebaseStorage.instance
            .ref()
            .child('projects/${projectID}/${projectID}.png')
            .getDownloadURL();
      } catch (e) {
