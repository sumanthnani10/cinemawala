...
class ScenePopUp extends StatefulWidget {
  final Project project;
  final Scene scene;

  ScenePopUp({Key key, @required this.project, @required this.scene})
      : super(key: key);

  @override
  _ScenePopUp createState() => _ScenePopUp(this.project, this.scene);
}

class _ScenePopUp extends State<ScenePopUp>
    with SingleTickerProviderStateMixin {
  final Project project;
  Scene scene;

  _ScenePopUp(this.project, this.scene);
